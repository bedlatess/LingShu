const admin = {
  ...
  channels: {
    ...
    syncModels: "同步模型",
    syncTitle: "同步上游模型",
    syncSummary: "上游 {{upstream}} 个 · 已绑定 {{bound}} 个 · 可新增 {{added}} 个",
    syncAllBound: "上游模型均已绑定，无需新增",
    syncConfirm: "导入所选模型",
    syncImported: "已导入 {{count}} 个模型",
    syncNoSelection: "请至少勾选一个模型",
    syncFailed: "同步模型失败",
    syncStrategy: "导入策略",
    syncStrategyCreateOrBind: "不存在则新建模型并绑定",
    syncStrategyBindExisting: "仅绑定已存在的模型",
    bindModel: "绑定模型",
    bindTitle: "绑定平台模型",
    bindPlatformModel: "平台模型",
    bindSelectModel: "请选择平台模型",
    bindUpstreamName: "上游模型名",
    bindUpstreamPlaceholder: "上游真实模型标识，如 gpt-4o",
    bindConfirm: "确认绑定",
    bindIncomplete: "请选择模型并填写上游模型名",
    bindSuccess: "绑定成功",
    bindFailed: "绑定模型失败",
    unbind: "解绑",
    unbindSuccess: "已解绑",
